/*************************************
 * ProgressCircle
 * Copyright © 2005 by Umut Tezduyar
 * http://www.UmutTezduyar.com
 * **********************************/
...
namespace Utezduyar.Windows.Forms
{
    /// <summary>
    ...
    /// </summary>
    [ToolboxBitmap(typeof(Utezduyar.Windows.Forms.ProgressCircle), "CircleToolboxBitmap.bmp")]
    public partial class ProgressCircle : System.Windows.Forms.UserControl
    {
        ...
        public ProgressCircle()
        {
            ...
            this._numberOfArcs = 12;
            this._ringThickness = 15;
            this._ringColor = Color.White;
            this.ForeColor = Color.LimeGreen;
            this._numberOfTail = 4;

            this.timer = new Timer();
            this.timer.Interval = 50; // Each 50 miliseconds, the progress circle will be drawn again
